...
import eotFont from './fontawesome-webfont.eot';
import svgFont from './fontawesome-webfont.svg';
import ttfFont from './fontawesome-webfont.ttf';
import woffFont from './fontawesome-webfont.woff';
import woff2Font from './fontawesome-webfont.woff2';
...
css.global('@font-face', {
  ...
  url('${svgFont}?#fontawesomeregular') format('svg')`,
  fontWeight: 'normal',
  fontStyle: 'normal'
});

// Keyframe animations
const faSpin = css.keyframes({
...
const styles = {
  ...
  '.fa-spin': {
    WebkitAnimation: `${faSpin} 2s infinite linear`,
    animation: `${faSpin} 2s infinite linear`,
  },
  '.fa-pulse': {
    WebkitAnimation: `${faSpin} 1s infinite steps(8)`,
